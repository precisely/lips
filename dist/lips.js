 ...
 *
 * build: Sat, 25 May 2019 10:03:15 +0000
 */
(function () {
	'use strict';
	...
	(function (root, factory) {
	  ...
	  Stream.prototype.peekChar = function (peekType) {
	    ...
	    if (peekType === true) {
	      ...
	      if (whitespace) {
	        ...
	        substring = this.string.substring(this.index);
	      }
	  ...
	  Stream.prototype.peekToken = function () {
	    ...
	    for (var _i = 0, _arr = [pre_parse_start_re, makeTokenRe(true)]; _i < _arr.length; _i++) {
	      var re = _arr[_i];
