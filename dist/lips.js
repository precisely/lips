	...
	(function (root, factory) {
	  ...
	  function ReadTable(rt) {
	    ...
	    this.symbolTerminatorRegex = function () {
	      if (!this._symbolTerminators) {
	        ...
	        terminatorChars = terminatorChars.map(function (c) {
	          return "\\" + c;
	        }).join("");
	    ...
	    this.setReaderFunction = function setReaderFunction(chars, fn, terminator) {
	      ...
	      chars.split('').forEach(function (c) {
	        ...
	        if (terminator) {
	          _this.terminators[c] = terminator;
	        }

	        _this.rebuildTerminatorTest();
	      });
	    };
	    ...
	    this.rebuildTerminatorTest = function rebuildTerminatorTest() {
	      ...
	      this.terminatorTest = {};
	      Object.values(this.terminators).forEach(function (terminator) {
	        return _this2.terminatorTest[terminator] = true;
	      });
	    };
	  }
	  ...
	  function macroExpand(single) {
	    return /*#__PURE__*/function () {
	      var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(code, args) {
	            ...
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                _traverse = function _traverse3() {
	                  _traverse = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(node) {
	                ...
	                traverse = function _traverse2(_x3) {
	                  return _traverse.apply(this, arguments);
	                };
	  ...
	  function pararel(name, fn) {
	    return new Macro(name, function (code) {
	      var _ref3 = arguments.length > 1 && arguments[1] !== undefined$1 ? arguments[1] : {},
	  ...
	  var global_env = new Environment({
	    ...
	    // ------------------------------------------------------------------
	    help: doc(new Macro('help', function (code, _ref4) {
	      var dynamic_scope = _ref4.dynamic_scope,
	          error = _ref4.error;
	      var symbol;
	    ...
	    // ------------------------------------------------------------------
	    'ignore': new Macro('ignore', function (code, _ref8) {
	    ...
	    // ------------------------------------------------------------------
	    'define-macro': doc(new Macro(macro, function (macro, _ref10) {
	      ...
	      function resolve_pair(pair, fn) {
	        ...
	        if (pair instanceof Pair && !isEmptyList(pair)) {
	          ...
	          if (isPromise(car) || isPromise(cdr)) {
	            return Promise.all([car, cdr]).then(function (_ref11) {
	    ...
	    display: doc(function () {
	      ...
	      (_this$get = this.get('stdout')).write.apply(_this$get, toConsumableArray(args.map(function (arg) {
	        return _this5.get('string')(arg, typeof arg === 'string');
	      })));
	    ...
	    'try': doc(new Macro('try', function (code, _ref13) {
	      var _this6 = this;
	    ...
	    // ------------------------------------------------------------------
	    or: doc(new Macro('or', function (code, _ref14) {
	  ...
	  function getFunctionArgs(rest, _ref16) {
	    var env = _ref16.env,
